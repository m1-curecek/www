        ...
        <header id="vrchol">        
            ...
            <nav>
                <ul id="samotneMenu">
                    ...
                    <li><a href="zanry.php" class="posunoutDolu">Žánry</a></li>
                    <li><a href="sprava.php" class="posunoutDolu">Správa</a></li>
                </ul>
            </nav>
            <div class="dokoncitObtekani"></div>
        </header>      
            <h2>Informace o autorovi</h2>
            <div class="dokoncitObtekani"></div>
        </div>

        <div class="w3-container">
        <table class="w3-table-all w3-card-4">
            <tr><th>Název</th><th>Jazyk<th>Počet stran</th></tr>
            <?php foreach($allKdb as $Kdb){ ?>
            <tr><td><?php echo $Kdb->nazev_kniha; ?></td><td><?php echo $Kdb->jazyk; ?></td><td><?php echo $Kdb->pocet_stran; ?></td></tr>
            <?php } ?>
            </table> 
        </div>
